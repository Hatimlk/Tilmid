    ...
    <div className="min-h-screen bg-gray-50 pb-20 overflow-x-hidden font-sans w-full max-w-full">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 bg-slate-900 text-white overflow-hidden rounded-b-[2.5rem] lg:rounded-b-[4rem] shadow-2xl">
         ...
         <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center">
             ...
             <h1 className="text-4xl md:text-6xl lg:text-8xl font-black mb-8 tracking-tight leading-[1.1] animate-fade-in-up animate-delay-100">
               اضمن تفوقك مع <br/>
      ...
      <div className="container mx-auto px-4 lg:px-8 mt-12 lg:mt-24 relative z-20 space-y-24">
        ...
        <div id="registration-card" className="grid grid-cols-1 lg:grid-cols-5 gap-10 animate-fade-in-up animate-delay-300">
            
            <div className="lg:col-span-3 bg-white rounded-[3rem] shadow-[0_40px_100px_-20px_rgba(0,0,0,0.1)] border border-gray-100 overflow-hidden relative group">
                 {isSuccess ? (
            ...
            <div className="lg:col-span-2 space-y-8">
                 <div className="bg-gradient-to-br from-primary to-royal p-8 rounded-[3rem] text-white shadow-2xl shadow-blue-500/20 text-center relative overflow-hidden group">
        ...
        <div className="max-w-5xl mx-auto">
            <div className="relative p-1 lg:p-2 rounded-[4rem] bg-gradient-to-r from-yellow-300 via-orange-400 to-yellow-500 shadow-2xl shadow-yellow-500/20 overflow-hidden group">
                ...
                <div className="relative bg-slate-900 rounded-[3.5rem] p-10 md:p-16 text-center overflow-hidden">
