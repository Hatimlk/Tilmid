    ...
    <div className="min-h-screen bg-white overflow-hidden font-sans">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 bg-slate-900 text-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-full text-blue-100 font-bold text-xs mb-6 animate-fade-in-up">
            <Users size={16} />
            <span>قصتنا ورؤيتنا</span>
          </div>
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-6 tracking-tight leading-tight animate-fade-in-up animate-delay-100">
            نحن أكثر من مجرد <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-blue-400">منصة تعليمية</span>
          </h1>
          <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed animate-fade-in-up animate-delay-200">
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="bg-white p-6 rounded-[2rem] shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 border border-gray-100 text-center group">
                <div className={`w-16 h-16 mx-auto ${item.bg} ${item.color} rounded-2xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform`}>
                  <item.icon size={28} />
                </div>
      ...
      <section className="py-20 lg:py-28 bg-blue-50/30">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto bg-white p-8 md:p-10 rounded-[2rem] border border-gray-100 shadow-lg relative overflow-hidden group hover:-translate-y-1 transition-all duration-300">
            {/* Decorative Elements */}
