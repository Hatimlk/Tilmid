...
import { 
  ...
  Clock, XCircle, Check, Ban, Unlock, Edit, Save, X, UserPlus, CalendarPlus, Bell
} from 'lucide-react';
...
export const AdminDashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col lg:flex-row font-sans" dir="rtl">
        {/* Sidebar */}
        <aside className="w-full lg:w-72 bg-slate-900 text-white p-6 flex flex-col shrink-0">
        ...
        <main className="flex-grow h-screen overflow-y-auto relative bg-[#F9FAFB]">
            ...
            <header className="bg-white px-8 py-5 border-b border-gray-200 sticky top-0 z-30 flex justify-between items-center shadow-[0_4px_20px_rgba(0,0,0,0.02)]">
                ...
                <div className="flex items-center gap-6">
                    {/* Settings Icon */}
                    <div className="p-2 text-gray-400 hover:bg-gray-50 rounded-xl cursor-pointer transition-colors border border-transparent hover:border-gray-100">
                        <Settings size={20} />
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                       <div className="relative">
                          <div className="w-11 h-11 rounded-full bg-[#0095ff] flex items-center justify-center text-white font-bold text-sm shadow-sm border-2 border-white">
                             AD
                          </div>
                    ...
                    {/* Notification Bell */}
                    <div className="relative">
                        <button className="p-3 bg-white border border-gray-100 rounded-2xl text-gray-500 hover:text-primary hover:shadow-md transition-all group">
            ...
            <div className="p-6 lg:p-10 max-w-7xl mx-auto">
                ...
                {activeTab === 'posts' && (
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 animate-in fade-in">
                        <div className="lg:col-span-1 bg-white p-8 rounded-3xl shadow-sm border border-gray-100 h-fit sticky top-28">
                            ...
                            <div className="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden">
                                <div className="max-h-[700px] overflow-y-auto custom-scrollbar">
                                    <table className="w-full text-right relative">
                                        <thead className="bg-gray-50 text-gray-500 text-xs font-extrabold uppercase sticky top-0 z-10 border-b border-gray-100"><tr><th className="p-6">المقال</th><th className="p-6">الحالة</th><th className="p-6">التاريخ</th><th className="p-6">إجراءات</th></tr></thead>
                                        <tbody className="divide-y divide-gray-50">
                                            {customPosts.map(post => (
                                                <tr key={post.id} className="hover:bg-blue-50/30 transition-colors group"><td className="p-6"><div className="flex items-center gap-4"><img src={post.image} className="w-12 h-12 rounded-xl object-cover shadow-sm" alt="" /><div><p className="font-bold text-gray-900 text-sm line-clamp-1 mb-1">{post.title}</p><span className="text-[10px] font-bold bg-gray-100 text-gray-500 px-2 py-0.5 rounded">{post.category}</span></div></div></td><td className="p-6"><StatusBadge status={post.status || 'published'} /></td><td className="p-6 text-sm font-bold text-gray-400">{post.date}</td><td className="p-6"><div className="flex gap-2 opacity-50 group-hover:opacity-100 transition-opacity"><button onClick={() => handleEditPost(post)} className="p-2.5 text-blue-600 bg-blue-50 rounded-xl hover:bg-blue-100 transition-colors"><PenTool size={18} /></button><button onClick={() => handleDeletePost(post.id)} className="p-2.5 text-red-600 bg-red-50 rounded-xl hover:bg-red-100 transition-colors"><Trash2 size={18} /></button></div></td></tr>
                                            ))}
                    ...
                    <div className="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 overflow-hidden animate-in fade-in">
                         <div className="p-8 border-b border-gray-100 flex justify-between items-center bg-white">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <button onClick={() => handleOpenStudentModal()} className="flex items-center gap-2 bg-gray-900 text-white px-6 py-3 rounded-xl font-bold text-sm hover:bg-primary shadow-lg hover:shadow-blue-500/30 hover:-translate-y-0.5 transition-all"><UserPlus size={18} /> إضافة طالب</button>
                            </div>
                         </div>
                                        ...
                                        <tr key={student.id} className="hover:bg-gray-50 transition-colors group">
                                            ...
                                            <td className="p-6">
                                                <div className="flex items-center justify-center gap-6">
                                                    <button className="text-gray-400 hover:text-primary text-xs font-bold underline transition-colors decoration-2 underline-offset-4">عرض الملف</button>
                ...
                {activeTab === 'appointments' && (
                    <div className="space-y-8 animate-in fade-in">
                        <div className="flex justify-end">
                             <button onClick={handleOpenAppointmentModal} className="flex items-center gap-2 bg-orange-500 text-white px-8 py-4 rounded-2xl font-bold shadow-lg shadow-orange-200 hover:bg-orange-600 hover:-translate-y-0.5 transition-all"><CalendarPlus size={20} /> حجز موعد جديد</button>
                        </div>
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-gray-100 h-fit">
                                ...
                                <div className="space-y-4 max-h-[600px] overflow-y-auto pr-2 custom-scrollbar">
                                    {appointments.filter(a => a.status !== 'pending').map(app => (
                                        <div key={app.id} className="flex items-center justify-between p-5 rounded-2xl bg-white border border-gray-100 group hover:shadow-md transition-all">
                                            ...
                                            <div className="flex items-center gap-4">
                                                ...
                                                <button onClick={() => deleteAppointment(app.id)} className="text-red-300 hover:text-red-600 opacity-0 group-hover:opacity-100 transition-all p-2 hover:bg-red-50 rounded-lg"><Trash2 size={18} /></button>
                                            </div>
                                        </div>
                                    ))}
